...
#library(shiny); wd <- "/Users/hoy/Desktop"; setwd(wd); runApp("choropleth")
#sudo rm -rf /srv/shiny-server/choropleth
#sudo cp -r /Users/hoy/Desktop/choropleth /srv/shiny-server/choropleth
